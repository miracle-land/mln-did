...
/**
 * The DidSolService class is a wrapper around the Miraland DID program.
...
export class DidSolService extends DidSolTransactionBuilder {
  ...
  /**
   * Initializes the did:mln account.
  ...
  /**
   * Add a VerificationMethod to the did:mln account.
   * Supports ethSignInstruction
  ...
  /**
   * Remove a VerificationMethod from the did:mln account.
  ...
  /**
   * Add a Service to the did:mln account.
   * Supports ethSignInstruction
  ...
  /**
   * Removes a Service to the did:mln account.
   * Supports ethSignInstruction
   ...
   * @param document A did:mln Document of the DID to update
   * @param authority The authority to use. Can be "wrong" if instruction is later signed with ethSigner
   */
  updateFromDoc(
  ...
  /**
   * Resolves the DID Document for the did:mln account.
   */
  ...
  /**
   * Resolves a legacy did:mln account (program: idDa...).
