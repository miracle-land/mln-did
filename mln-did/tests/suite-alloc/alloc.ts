...
describe('sol-did alloc operations', () => {
  ...
  it('can successfully close an did:mln account ', async () => {
  ...
  it('fails when trying to close a did:mln account that does not exist', async () => {
    const destination = anchor.web3.Keypair.generate();
  ...
  it('can successfully initialize an did:mln account with default size', async () => {
  ...
  it('fails when trying to initialize a did:mln account twice', async () => {
    return expect(
